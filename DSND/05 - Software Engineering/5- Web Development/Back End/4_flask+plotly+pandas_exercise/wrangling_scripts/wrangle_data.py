...
def cleandata(dataset, keepcolumns=['Country Name', '1990', '2015'],
...
def return_figures():
  ...
  # as a line chart
    ...
    for country in countrylist:
        ...
        graph_four.append(
            # go.Scatter(x=x_val, y=y_val, mode='markers', text=text, name=country, textposition='top')
    ...
    layout_five = dict(title='Rural Population in 2015',
                      xaxis=dict(title='Country'),
                      yaxis=dict(title='Rural Population per country')
                      )
