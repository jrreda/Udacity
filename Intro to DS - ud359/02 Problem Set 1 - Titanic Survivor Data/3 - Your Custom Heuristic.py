...
def custom_heuristic(file_path):
    ...
    for passenger_index, passenger in df.iterrows():
        ...
        #
        passenger_id = passenger['PassengerId']
        predictions[passenger_id] = 1 if ( (passenger['Sex']=='female' and passenger['SibSp']<3 \
                                            and passenger['Parch']<3)  or \
                                    (passenger['Age'] < 18 and passenger['Pclass'] == 1 and \
                                    passenger['SibSp'] < 3 and passenger['Parch'] < 3) ) else 0
    return predictions
